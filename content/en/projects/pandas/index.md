...
RTPPP_B2b is a C++ library that decodes BeiDou PPP‑B2b broadcasts and exposes precise orbit/clock corrections for real-time precise point positioning (PPP). It includes stream parsing, buffering, integrity checks, and utilities for seamless integration into GNSS processing pipelines.
...
- Stream parsing and buffering designed for real-time data
- Integrity checks and anomaly detection for robustness
- Simple APIs for plugging into existing PPP/filter pipelines
...
4. Output positioning or features for downstream tasks
